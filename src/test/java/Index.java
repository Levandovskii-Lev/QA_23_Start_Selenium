...
public class Index {
    ...
    public void setUp(){
        wd = new ChromeDriver();
        wd.get("file:///C:/Users/Lev/Downloads/21.index.html");
    }
    ...
    public void cssLocators(){
        ...
        WebElement el20 = wd.findElement(By.cssSelector("[name='surname']"));
        //by linkText & partial linkText
        WebElement a = wd.findElement(By.linkText("item1 "));
